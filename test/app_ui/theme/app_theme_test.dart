      ...
      group('switchTheme', () {
        group('thumbColor', () {
          test('returns darkAqua when selected', () {
            expect(
              const AppTheme().themeData.switchTheme.thumbColor?.resolve({MaterialState.selected}),
        ...
        group('trackColor', () {
          test('returns primaryContainer when selected', () {
            expect(
              const AppTheme().themeData.switchTheme.trackColor?.resolve({MaterialState.selected}),
